...
const NAV = [
  { label: "Dashboard",  icon: "📊", href: "/operator"          },
  { label: "My Trips",   icon: "🚌", href: "/operator/trips"    },
  { label: "Bookings",   icon: "🎫", href: "/operator/bookings" },
  { label: "Fleet",      icon: "🚐", href: "/operator/fleet"    },
  { label: "Profile",    icon: "👤", href: "/operator/profile"  },
];
